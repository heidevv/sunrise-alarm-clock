...
//***********define variables*************//
LiquidCrystal_I2C lcd(0x27,19,2); // Display  I2C 19 x 2 - changed to fit our LCD dimensions
RTC_DS1307 RTC;
...
//**************Alarm***************//
//#define LED 13  //took out this LED bc its digital - HW
#define LED1 10
...
void setup()
{
  ...
  pinMode(LED1,OUTPUT);
  //pinMode(buzzer, OUTPUT); // Set buzzer as an output - LED in our case
  printAllOff();
  Serial.begin(9600);
  Wire.begin();
  RTC.begin();
...
// We show the current date and time
  ...
  //FORMATTING DATE month/day/year
//  lcd.setCursor(0, 1);
  //lcd.print("Date : ");
